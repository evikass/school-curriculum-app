...
export const games: GameLesson[] = [
  {
    ...
    tasks: [
      ...
      { type: 'fill', question: "Сортировка пузырьком: O(__)", correctAnswer: "n²", hint: "Два вложенных цикла" },
  ...
  },
  {
    ...
    tasks: [
      ...
      { type: 'fill', question: "__ — запоминание результатов рекурсии", correctAnswer: "Мемоизация", hint: "Оптимизация рекурсии" },
  ...
  },
  {
    ...
    tasks: [
      ...
      { type: 'fill', question: "Табуляция — подход __ вверх", correctAnswer: "снизу", hint: "Итеративное заполнение" },
  ...
  },
  {
    ...
    tasks: [
      ...
      { type: 'fill', question: "Первичный __ — уникальный идентификатор", correctAnswer: "ключ", hint: "Primary key" },
  ...
  },
  {
    ...
    tasks: [
      ...
      { type: 'fill', question: "IPv4 состоит из __ бит", correctAnswer: "32", hint: "4 байта = 32 бита" },
  ...
  },
  {
    ...
    tasks: [
      ...
      { type: 'fill', question: "__ — язык программирования для веба", correctAnswer: "JavaScript", hint: "Клиентская логика" },
  ...
  },
  {
    ...
    tasks: [
      ...
      { type: 'fill', question: "SHA-256 — это __-функция", correctAnswer: "хеш", hint: "Необратимое преобразование" },
  ...
  },
  {
    ...
    tasks: [
      ...
      { type: 'fill', question: "__ — удалённый доступ, порт 22", correctAnswer: "SSH", hint: "Secure Shell" },
  ...
  },
  {
    ...
    tasks: [
      ...
      { type: 'fill', question: "Сколько единиц в 2¹⁰? __", correctAnswer: "1", hint: "2^n = 1 и n нулей" },
  ...
  },
  {
    ...
    tasks: [
      ...
      { type: 'fill', question: "Задание __ — обработка строк в ЕГЭ", correctAnswer: "24", hint: "Работа со строками" },
  ...
  },
  {
    ...
    tasks: [
      ...
      { type: 'fill', question: "Самое сложное задание — номер __", correctAnswer: "27", hint: "Эффективный алгоритм" },
