...
export const fourthGradeGames: GameLesson[] = [
  ...
  },
  {
    ...
    color: "text-red-400",
    tasks: [
      { type: 'quiz', question: "Какой знак ставится между однородными членами без союза?", options: ["Запятая", "Тире", "Двоеточие", "Точка", "Нет знака"], correctAnswer: "Запятая", hint: "Однородные члены без союза разделяются запятыми" },
  ...
  // ========== ЛИТЕРАТУРА ==========
  {
    ...
    tasks: [
      { type: 'quiz', question: "Кто главный герой былины об Илье Муромце?", options: ["Добрыня Никитич", "Илья Муромец", "Алёша Попович", "Садко", "Святогор"], correctAnswer: "Илья Муромец", hint: "Былина так и называется" },
      { type: 'quiz', question: "Сколько лет лежал Илья Муромец?", options: ["10 лет", "33 года", "50 лет", "20 лет", "100 лет"], correctAnswer: "33 года", hint: "«Тридцать три года лежал Илья...»" },
      ...
      { type: 'quiz', question: "Что такое былина?", options: ["Сказка", "Русская эпическая песня", "Стихотворение", "Рассказ", "Песня"], correctAnswer: "Русская эпическая песня", hint: "Былина рассказывает о подвигах богатырей" },
      { type: 'quiz', question: "Где происходили события былин?", options: ["В Киеве", "В Москве", "В Новгороде", "В Риме", "На Руси"], correctAnswer: "На Руси", hint: "Былины - о событиях на Руси" }
    ],
  ...
  },
  {
    ...
    color: "text-amber-400",
    tasks: [
      { type: 'quiz', question: "Кто написал «Бородино»?", options: ["Пушкин", "Лермонтов", "Тютчев", "Некрасов", "Фет"], correctAnswer: "Лермонтов", hint: "Михаил Юрьевич Лермонтов" },
  ...
  // ========== ОКРУЖАЮЩИЙ МИР ==========
  {
    ...
    tasks: [
      { type: 'quiz', question: "Кто крестил Русь?", options: ["Иван Грозный", "Князь Владимир", "Пётр I", "Ярослав Мудрый", "Князь Олег"], correctAnswer: "Князь Владимир", hint: "Владимир Святославич в 988 году" },
      { type: 'quiz', question: "В каком году была крещена Русь?", options: ["862", "988", "1147", "1000", "1054"], correctAnswer: "988", hint: "Крещение Руси - 988 год" },
      { type: 'find', question: "Выбери города Древней Руси:", options: ["Москва", "Киев", "Новгород", "Санкт-Петербург", "Чернигов"], correctAnswer: ["Киев", "Новгород", "Чернигов"], hint: "Москва и СПб основаны позже" },
      { type: 'quiz', question: "Кто призван на княжение в Новгород?", options: ["Олег", "Рюрик", "Владимир", "Игорь", "Святослав"], correctAnswer: "Рюрик", hint: "862 год - призвание варягов" },
      { type: 'quiz', question: "Как называлась летопись, рассказывающая о Древней Руси?", options: ["Велесова книга", "Повесть временных лет", "Слово о полку Игореве", "Задонщина", "Сказание о Мамаевом побоище"], correctAnswer: "Повесть временных лет", hint: "Написана монахом Нестором" }
    ],
  ...
  },
  {
    ...
    color: "text-green-400",
    tasks: [
      { type: 'quiz', question: "Какой орган перекачивает кровь?", options: ["Лёгкие", "Сердце", "Печень", "Почки", "Желудок"], correctAnswer: "Сердце", hint: "Сердце - главный орган кровеносной системы" },
  ...
  },
  {
    ...
    color: "text-amber-400",
    tasks: [
      { type: 'quiz', question: "Кто написал «Русалочка»?", options: ["Андерсен", "Братья Гримм", "Перро", "Толстой", "Пушкин"], correctAnswer: "Андерсен", hint: "Ганс Христиан Андерсен" },
  ...
  },
  {
    ...
    color: "text-green-400",
    tasks: [
      { type: 'quiz', question: "Что такое Красная книга?", options: ["Книга о природе", "Список редких животных", "Учебник", "Словарь", "Энциклопедия"], correctAnswer: "Список редких животных", hint: "Красная книга содержит редкие и исчезающие виды" },
  ...
  },
  {
    ...
    tasks: [
      { type: 'quiz', question: "Кто лечит животных?", options: ["Врач", "Ветеринар", "Учитель", "Повар", "Продавец"], correctAnswer: "Ветеринар", hint: "Ветеринар - врач для животных" },
  ...
  },
  {
    ...
    tasks: [
      { type: 'quiz', question: "Какая планета ближе всех к Солнцу?", options: ["Венера", "Меркурий", "Земля", "Марс", "Юпитер"], correctAnswer: "Меркурий", hint: "Меркурий - самая близкая к Солнцу" },
