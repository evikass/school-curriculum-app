...
export const eleventhGradeGames: GameLesson[] = [
  ...
  // ========== ОБЩЕСТВОЗНАНИЕ ==========
  {
    ...
    color: "text-violet-400",
    tasks: [
      { type: 'quiz', question: "Конституция - это:", options: ["Обычный закон", "Основной закон государства", "Указ президента"], correctAnswer: "Основной закон государства", hint: "Конституция имеет высшую юридическую силу" },
      { type: 'quiz', question: "Правоспособность возникает с:", options: ["Рождения", "14 лет", "18 лет"], correctAnswer: "Рождения", hint: "Способность иметь права" },
      ...
      { type: 'quiz', question: "Дееспособность в полном объёме наступает с:", options: ["14 лет", "16 лет", "18 лет"], correctAnswer: "18 лет", hint: "Совершеннолетие = полная дееспособность" }
    ],
  ...
  },
  {
    ...
    color: "text-violet-400",
    tasks: [
      { type: 'quiz', question: "Инфляция - это:", options: ["Снижение цен", "Повышение общего уровня цен", "Стабильность цен"], correctAnswer: "Повышение общего уровня цен", hint: "Обесценивание денег" },
      { type: 'quiz', question: "Спрос и предложение определяют:", options: ["Только предложение", "Рыночную цену", "Только спрос"], correctAnswer: "Рыночную цену", hint: "Закон спроса и предложения" },
  ...
  // ========== ГЕОГРАФИЯ ==========
  {
    ...
    color: "text-teal-400",
    tasks: [
      { type: 'quiz', question: "Самая длинная река России:", options: ["Волга", "Обь", "Лена"], correctAnswer: "Обь", hint: "Обь с Иртышом - самая длинная" },
      { type: 'quiz', question: "Самое глубокое озеро мира в России:", options: ["Ладожское", "Байкал", "Каспийское"], correctAnswer: "Байкал", hint: "Байкал - глубочайшее озеро" },
  ...
  },
  {
    ...
    color: "text-teal-400",
    tasks: [
      { type: 'quiz', question: "Самая большая страна мира по площади:", options: ["Китай", "США", "Россия"], correctAnswer: "Россия", hint: "17 млн км²" },
      { type: 'quiz', question: "Самая населённая страна мира:", options: ["Индия", "Китай", "США"], correctAnswer: "Индия", hint: "Индия превзошла Китай в 2023" },
  ...
  // ========== ИНФОРМАТИКА ==========
  {
    ...
    color: "text-sky-400",
    tasks: [
      { type: 'quiz', question: "Переменная в программировании - это:", options: ["Постоянное значение", "Именованная область памяти", "Команда"], correctAnswer: "Именованная область памяти", hint: "Хранит данные" },
      { type: 'quiz', question: "Цикл for используется для:", options: ["Однократного выполнения", "Многократного выполнения", "Остановки программы"], correctAnswer: "Многократного выполнения", hint: "Повторение кода" },
  ...
  },
  {
    ...
    color: "text-sky-400",
    tasks: [
      { type: 'quiz', question: "Массив - это:", options: ["Одна переменная", "Упорядоченный набор элементов", "Функция"], correctAnswer: "Упорядоченный набор элементов", hint: "Коллекция данных" },
      { type: 'quiz', question: "Сложность алгоритма O(n) означает:", options: ["Константное время", "Линейное время", "Квадратичное время"], correctAnswer: "Линейное время", hint: "Время растёт линейно" },
  ...
  // ========== ФИЗИКА: ЭЛЕКТРОДИНАМИКА ==========
  {
    ...
    color: "text-violet-400",
    tasks: [
      { type: 'quiz', question: "Закон Ома для участка цепи:", options: ["I = U/R", "I = UR", "I = R/U"], correctAnswer: "I = U/R", hint: "Ток = напряжение / сопротивление" },
      { type: 'fill', question: "Сила тока измеряется в __", correctAnswer: "амперах", hint: "Единица силы тока" },
      { type: 'quiz', question: "При последовательном соединении сопротивления:", options: ["Складываются", "Вычитаются", "Перемножаются"], correctAnswer: "Складываются", hint: "R = R₁ + R₂ + ..." },
  ...
  },
  {
    ...
    color: "text-violet-400",
    tasks: [
      { type: 'quiz', question: "Магнитное поле создаётся:", options: ["Покоющимися зарядами", "Движущимися зарядами", "Только магнитами"], correctAnswer: "Движущимися зарядами", hint: "Электрический ток создаёт магнитное поле" },
      { type: 'quiz', question: "Сила Лоренца действует на:", options: ["Покоющийся заряд", "Движущийся заряд", "Любой заряд"], correctAnswer: "Движущийся заряд", hint: "F = qvB" },
      ...
      { type: 'quiz', question: "Магнитный поток измеряется в:", options: ["Тесла", "Вебер", "Ампер"], correctAnswer: "Вебер", hint: "Ф = BS" }
    ],
  ...
  // ========== ХИМИЯ: ОРГАНИКА ==========
  {
    ...
    color: "text-emerald-400",
    tasks: [
      { type: 'quiz', question: "Алканы имеют общую формулу:", options: ["CₙH₂ₙ", "CₙH₂ₙ₊₂", "CₙH₂ₙ₋₂"], correctAnswer: "CₙH₂ₙ₊₂", hint: "Предельные углеводороды" },
      { type: 'quiz', question: "Этанол - это:", options: ["Кислота", "Спирт", "Альдегид"], correctAnswer: "Спирт", hint: "C₂H₅OH - этиловый спирт" },
  ...
  },
  {
    ...
    color: "text-emerald-400",
    tasks: [
      { type: 'quiz', question: "Алкены содержат:", options: ["Одинарную связь", "Двойную связь", "Тройную связь"], correctAnswer: "Двойную связь", hint: "C=C - двойная связь" },
      { type: 'quiz', question: "Бензол имеет структуру:", options: ["Линейную", "Циклическую", "Разветвлённую"], correctAnswer: "Циклическую", hint: "C₆H₆ - ароматическое кольцо" },
