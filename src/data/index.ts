...
import { games as grade2RussianGames } from './grades/2/russian'
import { games as grade2LiteratureGames } from './grades/2/literature'
import { games as grade2MathGames } from './grades/2/math'
import { games as grade2WorldGames } from './grades/2/world'
import { games as grade2EnglishGames } from './grades/2/english'
...
import { games as grade3WorldGames } from './grades/3/world'
import { games as grade3EnglishGames } from './grades/3/english'
...
import { games as grade3RussianGames } from './grades/3/russian'
...
import { games as grade5MusicGames } from './grades/5/music'
import { games as grade5SafetyGames } from './grades/5/safety'
import { games as grade5TechGames } from './grades/5/tech'
import { games as grade5ArtGames } from './grades/5/art'
import { games as grade5PEGames } from './grades/5/pe'
...
import { games as grade7TechGames } from './grades/7/tech'
import { games as grade7MusicGames } from './grades/7/music'
import { games as grade7PEGames } from './grades/7/pe'
import { games as grade7SafetyGames } from './grades/7/safety'
...
import { games as grade8AlgebraGames } from './grades/8/algebra'
...
import { games as grade8GeometryGames } from './grades/8/geometry'
import { games as grade8ChemistryGames } from './grades/8/chemistry'
import { games as grade8HistoryGames } from './grades/8/history'
import { games as grade8BiologyGames } from './grades/8/biology'
import { games as grade8GeographyGames } from './grades/8/geography'
import { games as grade8EnglishGames } from './grades/8/english'
import { games as grade8TechGames } from './grades/8/tech'
import { games as grade8ArtGames } from './grades/8/art'
import { games as grade8MusicGames } from './grades/8/music'
import { games as grade8PEGames } from './grades/8/pe'
import { games as grade8SafetyGames } from './grades/8/safety'
import { games as grade8RussianGames } from './grades/8/russian'
import { games as grade8LiteratureGames } from './grades/8/literature'
...
import { games as grade9GeometryGames } from './grades/9/geometry'
import { games as grade9PhysicsGames } from './grades/9/physics'
import { games as grade9ChemistryGames } from './grades/9/chemistry'
import { games as grade9BiologyGames } from './grades/9/biology'
import { games as grade9GeographyGames } from './grades/9/geography'
import { games as grade9HistoryGames } from './grades/9/history'
import { games as grade9RussianGames } from './grades/9/russian'
import { games as grade9LiteratureGames } from './grades/9/literature'
...
import { games as grade9EnglishGames } from './grades/9/english'
import { games as grade9TechGames } from './grades/9/tech'
import { games as grade9ArtGames } from './grades/9/art'
import { games as grade9MusicGames } from './grades/9/music'
import { games as grade9PEGames } from './grades/9/pe'
import { games as grade9SafetyGames } from './grades/9/safety'
...
import { games as grade10EnglishGames } from './grades/10/english'
import { lessons as grade10English } from './grades/10/english'
import { games as grade10InformaticsGames } from './grades/10/informatics'
import { lessons as grade10Informatics } from './grades/10/informatics'
import { games as grade10PEGames } from './grades/10/pe'
import { lessons as grade10PE } from './grades/10/pe'
import { games as grade10SafetyGames } from './grades/10/safety'
...
import { games as grade10AlgebraGames } from './grades/10/algebra'
import { games as grade10GeometryGames } from './grades/10/geometry'
import { games as grade10RussianGames } from './grades/10/russian'
import { games as grade10LiteratureGames } from './grades/10/literature'
import { games as grade10PhysicsGames } from './grades/10/physics'
import { games as grade10ChemistryGames } from './grades/10/chemistry'
import { games as grade10HistoryGames } from './grades/10/history'
import { games as grade10SocialGames } from './grades/10/social'
import { games as grade10BiologyGames } from './grades/10/biology'
import { games as grade10GeographyGames } from './grades/10/geography'
...
import { games as grade11LiteratureGames } from './grades/11/literature'
import { games as grade11RussianGames } from './grades/11/russian'
import { games as grade11AlgebraGames } from './grades/11/algebra'
import { games as grade11GeometryGames } from './grades/11/geometry'
import { games as grade11PhysicsGames } from './grades/11/physics'
import { games as grade11ChemistryGames } from './grades/11/chemistry'
import { games as grade11HistoryGames } from './grades/11/history'
...
import { games as grade11InformaticsGames } from './grades/11/informatics'
import { games as grade11PEGames } from './grades/11/pe'
import { games as grade11SafetyGames } from './grades/11/safety'
...
export const allGames: Record<number, GameLesson[]> = {
  ...
  8: [...eighthGradeGames, ...grade8AlgebraGames, ...grade8GeometryGames, ...grade8PhysicsGames, ...grade8ChemistryGames, ...grade8HistoryGames, ...grade8BiologyGames, ...grade8GeographyGames, ...grade8EnglishGames, ...grade8TechGames, ...grade8ArtGames, ...grade8MusicGames, ...grade8PEGames, ...grade8SafetyGames, ...grade8CodingGames, ...grade8SocialGames, ...grade8EconomyGames, ...grade8InformaticsGames, ...grade8RoboticsGames, ...grade8LawGames, ...grade8RussianGames, ...grade8LiteratureGames],
  9: [...ninthGradeGames, ...grade9AlgebraGames, ...grade9GeometryGames, ...grade9PhysicsGames, ...grade9ChemistryGames, ...grade9BiologyGames, ...grade9GeographyGames, ...grade9HistoryGames, ...grade9RussianGames, ...grade9LiteratureGames, ...grade9SocialGames, ...grade9CodingGames, ...grade9InformaticsGames, ...grade9PsychologyGames, ...grade9EconomyGames, ...grade9CareerGames, ...grade9OGEGames, ...grade9EnglishGames, ...grade9TechGames, ...grade9ArtGames, ...grade9MusicGames, ...grade9PEGames, ...grade9SafetyGames],
  10: [...tenthGradeGames, ...grade10AlgebraGames, ...grade10GeometryGames, ...grade10RussianGames, ...grade10LiteratureGames, ...grade10PhysicsGames, ...grade10ChemistryGames, ...grade10HistoryGames, ...grade10SocialGames, ...grade10BiologyGames, ...grade10GeographyGames, ...grade10EnglishGames, ...grade10InformaticsGames, ...grade10PEGames, ...grade10SafetyGames, ...grade10EconomyGames, ...grade10CodingGames, ...grade10TechGames, ...grade10ArtGames, ...grade10CareerGames, ...grade10AstronomyGames, ...grade10BusinessGames, ...grade10PhilosophyGames, ...grade10ProjectsGames, ...grade10LabGames, ...grade10EGEGames],
  11: [...eleventhGradeGames, ...grade11EconomyGames, ...grade11CodingGames, ...grade11LiteratureGames, ...grade11RussianGames, ...grade11AlgebraGames, ...grade11GeometryGames, ...grade11PhysicsGames, ...grade11ChemistryGames, ...grade11HistoryGames, ...grade11SocialGames, ...grade11BiologyGames, ...grade11GeographyGames, ...grade11EnglishGames, ...grade11InformaticsGames, ...grade11PEGames, ...grade11SafetyGames],
}
