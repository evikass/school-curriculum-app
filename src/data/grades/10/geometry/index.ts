...
export const games: GameLesson[] = [
  {
    ...
    tasks: [
      ...
      { type: 'quiz', question: "Площадь боковой поверхности прямой призмы: S = P · ___", options: ["H", "l", "S", "V", "a", "b"], correctAnswer: "H", hint: "P — периметр, H — высота" },
  ...
  },
  {
    ...
    tasks: [
      ...
      { type: 'quiz', question: "Диагональ прямоугольного параллелепипеда: d² = a² + b² + ___²", options: ["c", "d", "h", "l", "x", "y"], correctAnswer: "c", hint: "Три измерения" },
      { type: 'quiz', question: "Объём куба с ребром 3:", options: ["27", "9", "54", "18"], correctAnswer: "27", hint: "V = a³" },
      { type: 'quiz', question: "Площадь поверхности куба: S = 6·___²", options: ["a", "b", "c", "s", "v", "r"], correctAnswer: "a", hint: "Ребро куба" },
    ],
  ...
  },
  {
    ...
    tasks: [
      ...
      { type: 'quiz', question: "Апофема — это высота ___ грани пирамиды", options: ["боковой", "основания", "верхней", "нижней", "передней", "задней"], correctAnswer: "боковой", hint: "Проводится из вершины к основанию" },
      ...
      { type: 'quiz', question: "Объём пирамиды: V = ⅓·S_осн·___", options: ["H", "h", "l", "a", "b", "V"], correctAnswer: "H", hint: "Высота пирамиды" },
    ],
  ...
  },
  {
    ...
    tasks: [
      ...
      { type: 'quiz', question: "Площадь боковой поверхности цилиндра: S = 2πR·___", options: ["H", "h", "l", "r", "d", "s"], correctAnswer: "H", hint: "Высота цилиндра" },
  ...
  },
  {
    ...
    tasks: [
      ...
      { type: 'quiz', question: "Связь элементов конуса: l² = R² + ___²", options: ["H", "h", "r", "d", "s", "v"], correctAnswer: "H", hint: "Теорема Пифагора" },
      { type: 'quiz', question: "Объём конуса:", options: ["⅓πR²H", "πR²H", "½πR²H", "⅔πR²H"], correctAnswer: "⅓πR²H", hint: "В 3 раза меньше цилиндра" },
      { type: 'quiz', question: "Площадь боковой поверхности конуса: S = πR·___", options: ["l", "H", "h", "r", "s", "d"], correctAnswer: "l", hint: "Образующая конуса" },
    ],
  ...
  },
  {
    ...
    tasks: [
      ...
      { type: 'quiz', question: "Площадь сферы: S = ___πR²", options: ["4", "2", "6", "8", "3", "5"], correctAnswer: "4", hint: "Умножаем на 4" },
      { type: 'quiz', question: "Объём шара:", options: ["⁴⁄₃πR³", "4πR²", "πR³", "⅓πR³"], correctAnswer: "⁴⁄₃πR³", hint: "4/3 × π × R³" },
      { type: 'quiz', question: "Диаметр сферы: D = 2·___", options: ["R", "r", "d", "l", "h", "s"], correctAnswer: "R", hint: "Радиус" },
    ],
  ...
  },
  {
    ...
    tasks: [
      ...
      { type: 'quiz', question: "Объём цилиндра: V = π·___²·H", options: ["R", "r", "d", "h", "l", "s"], correctAnswer: "R", hint: "Радиус основания" },
      ...
      { type: 'quiz', question: "Объём усечённого конуса содержит множитель ⅓·___", options: ["π", "2π", "3π", "π²", "2", "4"], correctAnswer: "π", hint: "Как и обычный конус" },
    ],
  ...
  },
  {
    ...
    color: "text-cyan-400",
    tasks: [
      { type: 'quiz', question: "Площадь боковой поверхности цилиндра: S = ___πRH", options: ["2", "4", "6", "1", "3", "8"], correctAnswer: "2", hint: "Развёртка — прямоугольник" },
      { type: 'quiz', question: "Площадь боковой поверхности конуса:", options: ["πRl", "2πRl", "πRH", "πR²"], correctAnswer: "πRl", hint: "Развёртка — сектор" },
      { type: 'quiz', question: "Площадь полной поверхности цилиндра: S = 2πR(R + ___)", options: ["H", "h", "l", "r", "d", "s"], correctAnswer: "H", hint: "Высота" },
  ...
  },
  {
    ...
    color: "text-cyan-400",
    tasks: [
      { type: 'quiz', question: "Координаты точки в пространстве: (x, y, ___)", options: ["z", "Z", "a", "b", "c", "w"], correctAnswer: "z", hint: "Три координаты" },
      { type: 'quiz', question: "Длина вектора a⃗(3, 4, 0):", options: ["5", "7", "12", "25"], correctAnswer: "5", hint: "√(9+16+0)" },
      { type: 'quiz', question: "Координаты вектора AB: A(1,2,3), B(4,6,8) → AB = (3, 4, ___)", options: ["5", "6", "7", "4", "8", "11"], correctAnswer: "5", hint: "x₂-x₁, y₂-y₁, z₂-z₁" },
  ...
  },
  {
    ...
    tasks: [
      ...
      { type: 'quiz', question: "Сумма векторов (1,2,3) + (4,5,6) = (5, 7, ___)", options: ["9", "8", "10", "11", "7", "6"], correctAnswer: "9", hint: "Сложение координат" },
      { type: 'quiz', question: "Скалярное произведение a⃗·a⃗ равно:", options: ["|a⃗|²", "|a⃗|", "0", "1"], correctAnswer: "|a⃗|²", hint: "cos 0° = 1" },
      { type: 'quiz', question: "Угол между векторами: cos α = (a⃗·b⃗) / (|a⃗|·|___|)", options: ["b⃗", "a⃗", "v⃗", "u⃗", "w⃗", "c⃗"], correctAnswer: "b⃗", hint: "Длина второго вектора" },
    ],
  ...
  },
  {
    ...
    color: "text-cyan-400",
    tasks: [
      { type: 'quiz', question: "Уравнение плоскости: Ax + By + ___ + D = 0", options: ["Cz", "z", "cZ", "C", "cz", "Z"], correctAnswer: "Cz", hint: "Три переменные" },
      ...
      { type: 'quiz', question: "Нормальный вектор плоскости 2x + 3y - z + 5 = 0: n⃗ = (2, 3, ___)", options: ["-1", "1", "-5", "5", "0", "2"], correctAnswer: "-1", hint: "Коэффициенты при x, y, z" },
