  ...
  detailedTopics: [
    {
      ...
      lessons: [
        ...
        ], "/school-curriculum-app/images/lessons/grade10/english/lesson1.svg",
        ...
        ["Present Perfect: have/has + V3 — связывает прошлое с настоящим", "Past Perfect: had + V3 — действие завершилось до другого действия в прошлом", "Future Perfect: will have + V3 — действие завершится к определённому моменту"]),
        L("Урок 2: Passive Voice", "Страдательный залог.", [
          "Образование пассивного залога",
          "Все времена в пассиве",
          "Когда использовать пассив",
          "Примеры в речи"
        ], "/school-curriculum-app/images/lessons/grade10/english/lesson2.svg",
        ...
        ["Страдательный залог: be + V3 (причастие прошедшего времени)", "В Passive Voice неизвестно или неважно, кто совершает действие", "Passive Voice часто используется в научных текстах и новостях"]),
        L("Урок 3: Conditionals", "Условные предложения.", [
          "Zero Conditional",
          "First Conditional",
          "Second Conditional",
          "Third Conditional"
        ], "/school-curriculum-app/images/lessons/grade10/english/lesson3.svg",
        ...
        ["Zero Conditional: If + Present, Present — всегда истинные факты", "First Conditional: If + Present, will + V — реальное будущее условие", "Second Conditional: If + Past, would + V — нереальное условие"]),
        L("Урок 4: Reported Speech", "Косвенная речь.", [
          "Прямая и косвенная речь",
          "Изменение времён",
          "Изменение местоимений",
          "Вопросы в косвенной речи"
        ], "/school-curriculum-app/images/lessons/grade10/english/lesson4.svg",
        ...
        ["Косвенная речь передаёт чужие слова без прямой цитаты", "При переводе в косвенную речь времена сдвигаются назад (Backshift)", "Вопросы в косвенной речи становятся утверждениями с if/whether"])
      ]
    },
    {
      topic: "Лексика",
      lessons: [
        L("Урок 5: Phrasal Verbs", "Фразовые глаголы.", [
          ...
          "Употребление в речи"
        ], "/school-curriculum-app/images/lessons/grade10/english/lesson5.svg",
        ...
        ["Phrasal verb = глагол + предлог/наречие, значение часто не равно сумме частей", "Разделяемые phrasal verbs: put on, take off (местоимение между глаголом и частицей)", "Неразделяемые phrasal verbs: look after, run into"]),
        L("Урок 6: Idioms", "Английские идиомы.", [
          "Идиомы с частями тела",
          "Идиомы с животными",
          "Идиомы с цветами",
          "Использование в речи"
        ], "/school-curriculum-app/images/lessons/grade10/english/lesson6.svg",
        ...
        ["Идиома — устойчивое выражение, смысл которого не складывается из значений слов", "Идиомы делают речь более естественной и выразительной", "Не переводите идиомы дословно — используйте словари идиом"]),
        L("Урок 7: Word Formation", "Словообразование.", [
          "Префиксы",
          "Суффиксы существительных",
          "Суффиксы прилагательных",
          "Суффиксы глаголов"
        ], "/school-curriculum-app/images/lessons/grade10/english/lesson7.svg",
        ...
        ["Суффиксы и приставки помогают образовывать новые слова", "Negative prefixes: un-, in-, dis-, il-, ir-, im-", "Части речи можно менять с помощью суффиксов: -tion, -ment, -ness, -able"])
      ]
    },
    {
      ...
      lessons: [
        L("Урок 8: Reading Strategies", "Стратегии чтения.", [
          ...
          "Анализ текста"
        ], "/school-curriculum-app/images/lessons/grade10/english/lesson8.svg",
        ...
        ["Skimming — быстрое чтение для понимания основной идеи", "Scanning — поиск конкретной информации в тексте", "Чтение с пониманием требует активной работы с текстом и словарём"]),
        L("Урок 9: Text Analysis", "Анализ текста.", [
          "Структура текста",
          "Связность и логика",
          "Тон и стиль автора",
          "Главная идея текста"
        ], "/school-curriculum-app/images/lessons/grade10/english/lesson9.svg",
        ...
        ["Структура текста: введение, основная часть, заключение", "Ссылки и переходы (linking words) связывают предложения и абзацы", "Определите главную тему, ключевые аргументы и вывод автора"])
      ]
    },
    {
      topic: "Говорение",
      lessons: [
        L("Урок 10: Discussion Skills", "Навыки дискуссии.", [
          ...
          "Аргументация",
          "Вежливое прерывание"
        ], "/school-curriculum-app/images/lessons/grade10/english/lesson10.svg",
        ...
        ["Фразы согласия: I agree, That is right, You have a point", "Фразы несогласия: I am afraid I disagree, I see your point, but...", "Умение слушать и аргументировать — ключевые навыки дискуссии"])
      ]
    }
  ]
}
...
export const games: GameLesson[] = [
  {
    ...
    color: "text-pink-400",
    tasks: [
      { type: 'quiz', question: "Present Perfect образуется с помощью:", options: ["have/has + V3", "had + V3", "will have + V3", "is + Ving", "have + V2"], correctAnswer: "have/has + V3", hint: "I have finished. She has finished." },
      ...
      { type: 'quiz', question: "Future Perfect используется для:", options: ["Действия в прошлом", "Действия, которое завершится к моменту в будущем", "Действия сейчас", "Регулярного действия", "Действия в будущем"], correctAnswer: "Действия, которое завершится к моменту в будущем", hint: "By 2025 I will have graduated." },
      ...
      { type: 'quiz', question: "Какое время используется для действия до другого действия в прошлом?", options: ["Present Perfect", "Past Perfect", "Past Simple", "Future Perfect", "Present Perfect Continuous"], correctAnswer: "Past Perfect", hint: "He had left when I came." }
    ],
  ...
  },
  {
    ...
    color: "text-pink-400",
    tasks: [
      { type: 'quiz', question: "Passive Voice образуется:", options: ["be + V3", "have + V3", "will + V", "do + V", "was/were + Ving"], correctAnswer: "be + V3", hint: "The book is written." },
      ...
      { type: 'quiz', question: "Present Simple Passive:", options: ["am/is/are + V3", "was/were + V3", "will be + V3", "has been + V3", "had been + V3"], correctAnswer: "am/is/are + V3", hint: "English is spoken here." },
      ...
      { type: 'quiz', question: "Когда используется Passive Voice?", options: ["Когда важен объект или субъект неизвестен", "Когда важен субъект", "Всегда", "Никогда", "Когда важен глагол"], correctAnswer: "Когда важен объект или субъект неизвестен", hint: "The window was broken. (Кем? — неизвестно)" }
    ],
  ...
  },
  {
    ...
    tasks: [
      ...
      { type: 'quiz', question: "Zero Conditional описывает:", options: ["Факты и законы природы", "Реальное будущее", "Нереальное настоящее", "Нереальное прошлое", "Предложения с советами"], correctAnswer: "Факты и законы природы", hint: "If you heat ice, it melts." },
      { type: 'quiz', question: "First Conditional:", options: ["If + Present, will + V", "If + Past, would + V", "If + Present, Present", "If + Past Perfect, would have + V3", "If + Past Perfect, will + V"], correctAnswer: "If + Present, will + V", hint: "If it rains, I will stay home." },
      ...
      { type: 'quiz', question: "Third Conditional описывает:", options: ["Реальное будущее", "Нереальное настоящее", "Нереальное прошлое", "Факты", "Реальное настоящее"], correctAnswer: "Нереальное прошлое", hint: "If I had studied harder, I would have passed." }
    ],
  ...
  },
  {
    ...
    color: "text-pink-400",
    tasks: [
      { type: 'quiz', question: "В косвенной речи Present Simple меняется на:", options: ["Past Simple", "Present Perfect", "Future Simple", "Present Continuous", "Future Perfect"], correctAnswer: "Past Simple", hint: "\"I work\" → He said he worked." },
      ...
      { type: 'quiz', question: "Для общих вопросов в косвенной речи используется:", options: ["if/whether", "what", "where", "how", "when"], correctAnswer: "if/whether", hint: "He asked if I liked coffee." },
      ...
      { type: 'quiz', question: "В косвенной речи now меняется на:", options: ["then", "that day", "there", "the next day", "nowadays"], correctAnswer: "then", hint: "\"I'm busy now\" → He said he was busy then." }
    ],
  ...
  },
  {
    ...
    color: "text-pink-400",
    tasks: [
      { type: 'quiz', question: "give up означает:", options: ["бросить, отказаться", "начать", "искать", "поднять", "бросить"], correctAnswer: "бросить, отказаться", hint: "I gave up smoking." },
      ...
      { type: 'quiz', question: "run out of означает:", options: ["закончиться (о запасах)", "выбежать", "бежать из", "исчерпать", "выбежать из"], correctAnswer: "закончиться (о запасах)", hint: "We ran out of milk." },
      ...
      { type: 'quiz', question: "calm down означает:", options: ["успокоиться", "волноваться", "спускаться", "записывать", "задуматься"], correctAnswer: "успокоиться", hint: "Calm down, everything will be fine." }
    ],
  ...
  },
  {
    ...
    color: "text-pink-400",
    tasks: [
      { type: 'quiz', question: "break a leg означает:", options: ["ни пуха ни пера!", "сломать ногу", "быть больным", "идти медленно", "сломать руку"], correctAnswer: "ни пуха ни пера!", hint: "Break a leg at the audition!" },
      ...
      { type: 'quiz', question: "once in a blue moon означает:", options: ["очень редко", "каждый день", "ночью", "при полной луне", "каждый месяц"], correctAnswer: "очень редко", hint: "We meet once in a blue moon." },
      ...
      { type: 'quiz', question: "cost an arm and a leg означает:", options: ["стоить очень дорого", "стоить дёшево", "быть бесплатным", "стоять на ногах", "стоить ногу и руку"], correctAnswer: "стоить очень дорого", hint: "This car costs an arm and a leg." }
    ],
  ...
  },
  {
    ...
    color: "text-pink-400",
    tasks: [
      { type: 'quiz', question: "Префикс un- означает:", options: ["не-", "пере-", "пред-", "недо-", "anti-"], correctAnswer: "не-", hint: "unhappy, unusual" },
      ...
      { type: 'quiz', question: "Суффикс -less означает:", options: ["без качества", "с качеством", "обладающий", "деятель", "обладающий качеством"], correctAnswer: "без качества", hint: "useless, hopeless" },
      ...
      { type: 'quiz', question: "Суффикс существительного -tion означает:", options: ["действие", "деятель", "качество", "свойство", "процесс"], correctAnswer: "действие", hint: "education, decision" }
    ],
  ...
  },
  {
    ...
    color: "text-pink-400",
    tasks: [
      { type: 'quiz', question: "Skimming — это:", options: ["беглое чтение для общего понимания", "поиск конкретной информации", "детальное чтение", "чтение вслух", "глубокое понимание деталей"], correctAnswer: "беглое чтение для общего понимания", hint: "Чтение заголовков и первых предложений" },
      ...
      { type: 'quiz', question: "При скимминге нужно:", options: ["Читать заголовки и первые предложения абзацев", "Читать каждое слово", "Искать конкретные даты", "Переводить текст", "запоминать каждое слово"], correctAnswer: "Читать заголовки и первые предложения абзацев", hint: "Быстрое понимание сути текста" },
      ...
      { type: 'quiz', question: "Что НЕ нужно делать при чтении?", options: ["Переводить каждое слово", "Угадывать значение по контексту", "Обращать внимание на связки слов", "Читать регулярно", "читать быстро"], correctAnswer: "Переводить каждое слово", hint: "Это замедляет чтение" }
    ],
  ...
  },
  {
    ...
    color: "text-pink-400",
    tasks: [
      { type: 'quiz', question: "Структура текста:", options: ["Introduction — Body — Conclusion", "Beginning — Middle — End", "Head — Body — Tail", "First — Second — Third", "заголовок — основная часть — заключение"], correctAnswer: "Introduction — Body — Conclusion", hint: "Введение, основная часть, заключение" },
      ...
      { type: 'quiz', question: "However, nevertheless — слова для:", options: ["Противопоставления", "Добавления", "Примеров", "Заключения", "причина и следствие"], correctAnswer: "Противопоставления", hint: "Однако, тем не менее" },
      ...
      { type: 'quiz', question: "Тон текста может быть:", options: ["Формальным, неформальным, ироничным", "Только формальным", "Только нейтральным", "Только критическим", "только позитивным"], correctAnswer: "Формальным, неформальным, ироничным", hint: "Отношение автора к предмету" }
    ],
  ...
  },
  {
    ...
    tasks: [
      ...
      { type: 'quiz', question: "I couldn't agree more означает:", options: ["Полностью согласен", "Не согласен", "Частично согласен", "Скорее согласен", "полностью не согласен"], correctAnswer: "Полностью согласен", hint: "Не могу не согласиться" },
      ...
      { type: 'quiz', question: "Для вежливого прерывания используют:", options: ["Sorry to interrupt, but...", "Stop talking!", "Be quiet!", "Shut up!", "Excuse me, can I add something?"], correctAnswer: "Sorry to interrupt, but...", hint: "Извините, что перебиваю, но..." },
