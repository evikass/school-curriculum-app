  ...
  detailedTopics: [
      ...
      lessons: [
        {
          ...
          description: 'Понимание сложности алгоритмов и их классификация',
          tasks: ['Определить сложность алгоритма', 'Сравнить алгоритмы по эффективности'],
        ...
        },
        {
          ...
          description: 'Алгоритмы сортировки и их применение',
          tasks: ['Реализовать алгоритм сортировки', 'Сравнить методы сортировки'],
        ...
        },
        {
          ...
          tasks: ['Реализовать стек', 'Реализовать очередь'],
        ...
        },
        {
          ...
          description: 'Иерархические и сетевые структуры данных',
          tasks: ['Построить бинарное дерево', 'Реализовать обход графа'],
      ...
      lessons: [
        {
          ...
          description: 'Основы ООП: классы и экземпляры',
          tasks: ['Создать класс', 'Создать экземпляры класса'],
        ...
        },
        {
          ...
          tasks: ['Создать приватные атрибуты', 'Реализовать свойства'],
        ...
        },
        {
          ...
          tasks: ['Создать дочерний класс', 'Переопределить метод'],
        ...
        {
          title: 'Полиморфизм',
          description: 'Единый интерфейс для разных форм',
          tasks: ['Реализовать полиморфный метод', 'Использовать абстрактный класс'],
      ...
      lessons: [
        {
          ...
          tasks: ['Прочитать файл', 'Записать данные в файл'],
        ...
        },
        {
          ...
          description: 'Форматы обмена данными',
          tasks: ['Сохранить данные в JSON', 'Прочитать CSV-файл'],
        ...
        },
        {
          ...
          tasks: ['Написать SELECT-запрос', 'Добавить данные в таблицу'],
        ...
        },
        {
          ...
          tasks: ['Создать базу данных', 'Выполнить SQL-запрос'],
    ...
    },
    {
      ...
      lessons: [
        {
          title: 'Основы HTML',
          description: 'Язык разметки веб-страниц',
          tasks: ['Создать HTML-страницу', 'Добавить заголовки и абзацы'],
        ...
        },
        {
          ...
          tasks: ['Добавить стили к странице', 'Использовать Flexbox'],
        ...
        },
        {
          ...
          tasks: ['Создать маршрут', 'Запустить сервер'],
        ...
        },
        {
          ...
          tasks: ['Создать HTML-форму', 'Обработать отправку формы'],
      ...
      lessons: [
        {
          ...
          description: 'Создание GUI на Python',
          tasks: ['Создать окно', 'Добавить виджеты'],
        ...
        {
          title: 'Создание форм',
          description: 'Поля ввода и кнопки',
          tasks: ['Создать поле ввода', 'Обработать данные формы'],
        ...
        },
        {
          ...
          tasks: ['Привязать функцию к кнопке', 'Обработать нажатие клавиши'],
        ...
        },
        {
          ...
          description: 'Дополнительные элементы интерфейса',
          tasks: ['Создать меню', 'Показать диалоговое окно'],
      ...
      lessons: [
        {
          ...
          tasks: ['Использовать print-отладку', 'Поставить точку останова'],
        ...
        },
        {
          ...
          tasks: ['Написать unit-тест', 'Запустить тесты'],
        ...
        },
        {
          ...
          description: 'Комментарии и документация',
          tasks: ['Добавить docstring', 'Создать README'],
        ...
        },
        {
          ...
          description: 'Исключения и их обработка',
          tasks: ['Использовать try-except', 'Создать своё исключение'],
      ...
      lessons: [
        {
          ...
          tasks: ['Создать репозиторий', 'Сделать коммит'],
        ...
        },
        {
          ...
          description: 'Работа с ветками в Git',
          tasks: ['Создать ветку', 'Слить ветки'],
        ...
        },
        {
          ...
          description: 'Удалённые репозитории',
          tasks: ['Отправить изменения на GitHub', 'Создать Pull Request'],
        ...
        },
        {
          ...
          tasks: ['Проверить код на PEP 8', 'Настроить линтер'],
      ...
      lessons: [
        {
          ...
          description: 'Определение целей и задач',
          tasks: ['Выбрать тему проекта', 'Составить план'],
        ...
        },
        {
          ...
          tasks: ['Начать разработку', 'Проводить тестирование'],
        ...
        },
        {
          ...
          description: 'Представление результатов',
          tasks: ['Подготовить презентацию', 'Провести демонстрацию'],
        ...
        },
        {
          ...
          tasks: ['Провести ретроспективу', 'Спланировать развитие'],
