    ...
    tasks: [
      {
        ...
        options: ["С идеи", "С конца", "С середины", "С задания", "С плана"],
      ...
      },
      {
        ...
        options: ["Защита", "Подготовка", "Исследование", "Презентация", "Анализ"],
      ...
      },
      {
        ...
        options: ["Выступить и рассказать", "Написать текст", "Нарисовать рисунок", "Спрятать проект", "Показать картинку"],
    ...
    tasks: [
      {
        ...
        options: ["Коллаж", "Урок", "Контрольная", "Дневник", "Семейное древо"],
      ...
      },
      {
        ...
        options: ["Рассказ о работе", "Проверка", "Перемена", "Показать картинки", "Показать видео"],
      ...
      },
      {
        ...
        options: ["Родители", "Учитель", "Никто", "Все могут помочь", "Бабушка и дедушка"],
    ...
    tasks: [
      {
        type: 'quiz',
        question: "С чего начинается любой проект?",
        options: ["С защиты", "С идеи", "С поиска материалов", "С обсуждения", "С подготовки"],
        correctAnswer: "С идеи",
      ...
      },
      {
        ...
        options: ["Сложной", "Интересной", "Неизвестной", "Длинной", "Короткой"],
    ...
    tasks: [
      {
        ...
        options: ["В книгах", "В интернете", "Только у учителя", "В игре", "В разговоре"],
      ...
      },
      {
        ...
        options: ["Запомнить", "Записать", "Забыть", "Прочитать", "Пересказать"],
    ...
    tasks: [
      {
        ...
        options: ["Идея", "Готовый результат", "План", "Конечный итог", "Результат работы"],
      ...
      },
      {
        ...
        options: ["Скорость", "Качество", "Красота", "Надёжность", "Функциональность"],
    ...
    tasks: [
      {
        ...
        options: ["Спрятать проект", "Рассказать о проекте", "Сделать проект", "Показать работу", "Представить成果"],
      ...
      },
      {
        ...
        options: ["Быстро", "Чётко и понятно", "Тихо", "Ясно", "По порядку"],
    ...
    tasks: [
      {
        ...
        options: ["Быстрее", "Интереснее", "Легче", "Веселее", "Эффективнее"],
      ...
      },
      {
        ...
        options: ["Драться", "Договариваться", "Обижаться", "Слушать друг друга", "Искать компромисс"],
