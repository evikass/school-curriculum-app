...
export const games: GameLesson[] = [
  {
    ...
    color: "text-pink-400",
    tasks: [
      { type: 'quiz', question: "Вопрос 1 по теме \"Дикие животные\"", options: ["Только в теории","Ни один из вариантов","Не применяется","Дикие животные","Ни в каком из случаев"], correctAnswer: "Дикие животные", hint: "Ответ связан с материалом урока" },
      { type: 'quiz', question: "Вопрос 2 по теме \"Дикие животные\"", options: ["Во всех случаях","Только A и B","Всё вышеперечисленное","Ни в каком из случаев","Дикие животные"], correctAnswer: "Дикие животные", hint: "Ответ связан с материалом урока" },
      { type: 'quiz', question: "Вопрос 3 по теме \"Дикие животные\"", options: ["Только в теории","Ни в каком из случаев","Дикие животные","Зависит от контекста","Всё вышеперечисленное"], correctAnswer: "Дикие животные", hint: "Ответ связан с материалом урока" },
      { type: 'quiz', question: "Вопрос 4 по теме \"Дикие животные\"", options: ["Дикие животные","Ни один из вариантов","Всё вышеперечисленное","Только в теории","Во всех случаях"], correctAnswer: "Дикие животные", hint: "Ответ связан с материалом урока" },
      { type: 'quiz', question: "Вопрос 5 по теме \"Дикие животные\"", options: ["Ни в каком из случаев","Всё вышеперечисленное","Дикие животные","Только в теории","Не применяется"], correctAnswer: "Дикие животные", hint: "Ответ связан с материалом урока" }
    ],
  ...
  },
  {
    ...
    color: "text-pink-400",
    tasks: [
      { type: 'quiz', question: "Вопрос 1 по теме \"Цвета\"", options: ["Цвета","Во всех случаях","Не применяется","Ни один из вариантов","Всё вышеперечисленное"], correctAnswer: "Цвета", hint: "Ответ связан с материалом урока" },
      { type: 'quiz', question: "Вопрос 2 по теме \"Цвета\"", options: ["Зависит от контекста","Цвета","Только A и B","Ни в каком из случаев","Во всех случаях"], correctAnswer: "Цвета", hint: "Ответ связан с материалом урока" },
      { type: 'quiz', question: "Вопрос 3 по теме \"Цвета\"", options: ["Зависит от контекста","Цвета","Ни в каком из случаев","Не применяется","Ни один из вариантов"], correctAnswer: "Цвета", hint: "Ответ связан с материалом урока" },
      { type: 'quiz', question: "Вопрос 4 по теме \"Цвета\"", options: ["Только в теории","Цвета","Всё вышеперечисленное","Во всех случаях","Ни один из вариантов"], correctAnswer: "Цвета", hint: "Ответ связан с материалом урока" },
      { type: 'quiz', question: "Вопрос 5 по теме \"Цвета\"", options: ["Цвета","Только в теории","Только A и B","Во всех случаях","Зависит от контекста"], correctAnswer: "Цвета", hint: "Ответ связан с материалом урока" }
    ],
    reward: { stars: 3, message: "Отлично! Ты справился! 🎉" }
  },
  {
    ...
    color: "text-pink-400",
    tasks: [
      { type: 'quiz', question: "Вопрос 1 по теме \"Числа 1-20\"", options: ["Ни в каком из случаев","Только в теории","Зависит от контекста","Только A и B","Числа 1-20"], correctAnswer: "Числа 1-20", hint: "Ответ связан с материалом урока" },
      { type: 'quiz', question: "Вопрос 2 по теме \"Числа 1-20\"", options: ["Ни один из вариантов","Зависит от контекста","Ни в каком из случаев","Числа 1-20","Во всех случаях"], correctAnswer: "Числа 1-20", hint: "Ответ связан с материалом урока" },
      { type: 'quiz', question: "Вопрос 3 по теме \"Числа 1-20\"", options: ["Всё вышеперечисленное","Не применяется","Ни один из вариантов","Во всех случаях","Числа 1-20"], correctAnswer: "Числа 1-20", hint: "Ответ связан с материалом урока" },
      { type: 'quiz', question: "Вопрос 4 по теме \"Числа 1-20\"", options: ["Только в теории","Всё вышеперечисленное","Числа 1-20","Только A и B","Ни в каком из случаев"], correctAnswer: "Числа 1-20", hint: "Ответ связан с материалом урока" },
      { type: 'quiz', question: "Вопрос 5 по теме \"Числа 1-20\"", options: ["Ни один из вариантов","Только A и B","Зависит от контекста","Числа 1-20","Всё вышеперечисленное"], correctAnswer: "Числа 1-20", hint: "Ответ связан с материалом урока" }
    ],
    reward: { stars: 3, message: "Отлично! Ты справился! 🎉" }
  }
] = [
