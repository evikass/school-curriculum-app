...
export const games: GameLesson[] = [
  {
    ...
    color: "text-pink-400",
    tasks: [
      { type: 'quiz', question: "If I had studied, I ____ have a degree now.", options: ["would", "will", "would have", "might", "could"], correctAnswer: "would", hint: "Mixed: условие в прошлом, результат сейчас" },
      { type: 'quiz', question: "Had I known = ?", options: ["If I had known", "If I knew", "If I have known", "If I know", "If I will know"], correctAnswer: "If I had known", hint: "Инверсия в условном предложении" },
      ...
      { type: 'quiz', question: "Were I rich... — это:", options: ["Past Simple", "Инверсия (без if)", "Present Simple", "Future Simple", "Perfect Simple"], correctAnswer: "Инверсия (без if)", hint: "Were I = If I were" }
    ],
  ...
  },
  {
    ...
    color: "text-pink-400",
    tasks: [
      { type: 'quiz', question: "Never ____ I seen such beauty.", options: ["have", "has", "did", "had", "was"], correctAnswer: "have", hint: "Never have I seen..." },
      { type: 'quiz', question: "Only then ____ she understand.", options: ["did", "does", "has", "could", "will"], correctAnswer: "did", hint: "Only then did she understand." },
      ...
      { type: 'quiz', question: "She likes coffee. So __ I.", options: ["do", "am", "like", "does", "will"], correctAnswer: "do", hint: "So do I = Я тоже" }
    ],
  ...
  },
  {
    ...
    color: "text-pink-400",
    tasks: [
      { type: 'quiz', question: "I suggest that he ____ more careful. (subjunctive)", options: ["be", "is", "was", "were", "being"], correctAnswer: "be", hint: "Present Subjunctive — базовая форма" },
      { type: 'quiz', question: "I wish I ____ rich. (сожаление о настоящем)", options: ["am", "were", "be", "will", "would"], correctAnswer: "were", hint: "Past Subjunctive — were для всех лиц" },
      ...
      { type: 'quiz', question: "You ____ better study. (совет)", options: ["had", "would", "should", "will", "must"], correctAnswer: "had", hint: "Had better = тебе лучше" }
    ],
  ...
  },
  {
    ...
    color: "text-pink-400",
    tasks: [
      { type: 'quiz', question: "It was John ____ broke the window. (cleft sentence)", options: ["who", "which", "what", "that", "whom"], correctAnswer: "who", hint: "It was... who... = Именно..." },
      { type: 'quiz', question: "____ down the street, I met an old friend.", options: ["Walking", "Walked", "Walk", "Running", "Jumping"], correctAnswer: "Walking", hint: "Present Participle = активное действие" },
      { type: 'quiz', question: "What I need ____ a cup of coffee.", options: ["is", "are", "was", "were", "be"], correctAnswer: "is", hint: "Wh-cleft: What... is..." },
      { type: 'quiz', question: "He is ____ young to drive.", options: ["too", "so", "very", "such", "rather"], correctAnswer: "too", hint: "Too... to = слишком... чтобы" }
    ],
  ...
  },
  {
    ...
    color: "text-pink-400",
    tasks: [
      { type: 'quiz', question: "Анализировать данные — ____ the data.", options: ["analyse", "make", "do", "interpret", "examine"], correctAnswer: "analyse", hint: "Analyse = анализировать" },
      { type: 'quiz', question: "Ключевой фактор — a key ____.", options: ["issue", "factor", "aspect", "element", "component"], correctAnswer: "factor", hint: "Factor = фактор" },
      ...
      { type: 'quiz', question: "В заключение — In ____.", options: ["end", "conclusion", "finish", "summary", "closing"], correctAnswer: "conclusion", hint: "In conclusion" }
    ],
  ...
  },
  {
    ...
    color: "text-pink-400",
    tasks: [
      { type: 'quiz', question: "Главная мысль эссе — ____ statement.", options: ["thesis", "topic", "main", "central", "primary"], correctAnswer: "thesis", hint: "Thesis statement = тезис" },
      { type: 'quiz', question: "Первое предложение абзаца — ____ sentence.", options: ["topic", "main", "first", "opening", "initial"], correctAnswer: "topic", hint: "Topic sentence = тематическое предложение" },
      ...
      { type: 'quiz', question: "Заключение эссе должно:", options: ["Вводить новые идеи", "Обобщать основные пункты", "Быть самым длинным", "Содержать факты", "Вводить новые аргументы"], correctAnswer: "Обобщать основные пункты", hint: "Заключение = summary" }
    ],
  ...
  },
  {
    ...
    color: "text-pink-400",
    tasks: [
      { type: 'quiz', question: "My primary ____ is that... (аргумент)", options: ["argument", "point", "idea", "claim", "reason"], correctAnswer: "argument", hint: "Argument = аргумент" },
      { type: 'quiz', question: "Атака на личность — логическая ошибка:", options: ["Straw Man", "Ad Hominem", "False Dichotomy", "Personal Attack", "Appeal to Emotion"], correctAnswer: "Ad Hominem", hint: "Ad Hominem = к человеку" },
      ...
      { type: 'quiz', question: "«Или ты с нами, или против нас» — это:", options: ["Straw Man", "False Dichotomy", "Slippery Slope", "Black-or-white thinking", "Appeal to Emotion"], correctAnswer: "False Dichotomy", hint: "Ложная дилемма" }
    ],
  ...
  },
  {
    ...
    color: "text-pink-400",
    tasks: [
      { type: 'quiz', question: "Dear Mr. Smith, ... Yours ____.", options: ["faithfully", "sincerely", "truly", "respectfully", "cordially"], correctAnswer: "sincerely", hint: "Yours sincerely — когда знаете имя" },
      { type: 'quiz', question: "Я пишу, чтобы узнать о... — I am writing to ____ about...", options: ["inquire", "ask", "know", "request", "learn"], correctAnswer: "inquire", hint: "Inquire = узнавать, справляться" },
      ...
      { type: 'quiz', question: "I look forward ____ from you.", options: ["hear", "to hear", "to hearing", "hearing", "heard"], correctAnswer: "to hearing", hint: "look forward to + -ing" }
    ],
  ...
  },
  {
    ...
    color: "text-pink-400",
    tasks: [
      { type: 'quiz', question: "Tell me about ____. (о себе)", options: ["you", "yourself", "yours", "you're", "myself"], correctAnswer: "yourself", hint: "Tell me about yourself" },
      { type: 'quiz', question: "What are your ____? (сильные стороны)", options: ["strengths", "powers", "forces", "advantages", "talents"], correctAnswer: "strengths", hint: "Strengths = сильные стороны" },
      { type: 'quiz', question: "Why should we ____ you?", options: ["hire", "hired", "hiring", "hires", "fire"], correctAnswer: "hire", hint: "hire = нанять" },
      { type: 'quiz', question: "Спасибо за интервью — Thank you email отправить:", options: ["В тот же день", "В течение 24 часов", "Через неделю", "Через два дня", "Когда вспомню"], correctAnswer: "В течение 24 часов", hint: "Thank you email — в течение 24 часов" }
    ],
  ...
  },
  {
    ...
    color: "text-pink-400",
    tasks: [
      { type: 'quiz', question: "Today I'm going to ____ about...", options: ["talk", "speak", "tell", "say", "discuss"], correctAnswer: "talk", hint: "talk about = говорить о" },
      { type: 'quiz', question: "Какой процент времени — введение?", options: ["5%", "10-15%", "30%", "20%", "25%"], correctAnswer: "10-15%", hint: "Introduction = 10-15%" },
      ...
      { type: 'quiz', question: "I'd be happy to ____ any questions.", options: ["answer", "reply", "respond", "address", "explain"], correctAnswer: "answer", hint: "answer questions = отвечать на вопросы" }
    ],
