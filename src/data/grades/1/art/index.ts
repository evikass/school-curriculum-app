  ...
  },
  {
    ...
    tasks: [
      ...
      },
      {
        ...
        options: ["Красный + Жёлтый", "Синий + Жёлтый", "Красный + Синий"],
    ...
    tasks: [
      {
        ...
        options: ["Волнистая 〰️", "Прямая ➖", "Ломаная ⚡"],
      ...
      },
      {
        ...
        options: ["Рисунок линиями", "Закрашивание", "Обводка"],
      ...
      },
      {
        ...
        options: ["Прямая", "Волнистая", "Ломаная"],
        correctAnswer: ["Линейка ➖", "Волна 〰️", "Молния ⚡"],
  ...
  },
  {
    ...
    tasks: [
      ...
      },
      {
        ...
        options: ["Акварель", "Гуашь", "Акварель и гуашь"],
        correctAnswer: "Гуашь",
    ...
    tasks: [
      {
        ...
        options: ["Тот, кто поёт", "Тот, кто рисует", "Тот, кто танцует"],
      ...
      },
      {
        ...
        options: ["Рисунок природы", "Рисунок человека", "Рисунок фруктов"],
      ...
      },
      {
        ...
        options: ["Рисунок природы", "Рисунок человека", "Рисунок цветов"],
