...
export const games = [
  ...
  },
  {
    ...
    examples: ['Пример: Растения — изучение живых организмов', 'Практическое задание по теме «Растения»'],
  },
  {
    ...
    keyPoints: ['Основные понятия темы «Строение цветковых растений»', 'Ключевые правила и определения', 'Применение знаний на практике'],
    examples: ['Пример: Строение цветковых растений — изучение живых организмов', 'Практическое задание по теме «Строение цветковых растений»'],
  },
  {
    ...
    keyPoints: ['Основные понятия темы «Водоросли и мхи»', 'Ключевые правила и определения', 'Применение знаний на практике'],
    examples: ['Пример: Водоросли и мхи — изучение живых организмов', 'Практическое задание по теме «Водоросли и мхи»'],
  },
  {
    title: "Роль бактерий в природе и жизни человека",
