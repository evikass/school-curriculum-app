...
export const games: GameLesson[] = [
  ...
  },
  {
    ...
    tasks: [
      ...
      { type: 'quiz', question: "Как перебрать символы строки в Python?", options: ["for i in len(str)", "for letter in 'Hello'", "for char of 'Hello'", "loop 'Hello'", "Другой ответ"], correctAnswer: "for letter in 'Hello'", hint: "Цикл for с переменной и строкой" },
  ...
  },
  {
    ...
    tasks: [
      ...
      { type: 'quiz', question: "Какой цикл может быть бесконечным?", options: ["for i in range(10)", "while True", "for letter in 'Hi'", "Оба варианта", "Другой ответ"], correctAnswer: "while True", hint: "Условие всегда истинно" },
