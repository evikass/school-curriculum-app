...
export const games = [
  ...
  },
  {
    ...
    tasks: [
      ...
      { type: 'find', question: "Выберите последствия церковного раскола:", options: ["Старообрядцы", "Единство церкви", "Гонения на раскольников", "Церковный собор", "Ссылка Аввакума"], correctAnswer: ["Старообрядцы", "Гонения на раскольников", "Ссылка Аввакума"], hint: "XVII век" }
    ],
