...
export const games = [
  ...
  },
  {
    ...
    keyPoints: ['Основные понятия темы «Смутное время»', 'Ключевые правила и определения', 'Применение знаний на практике'],
    examples: ['Пример: Смутное время — исторический анализ', 'Практическое задание по теме «Смутное время»'],
  },
  {
    ...
    keyPoints: ['Основные понятия темы «Объединение Руси»', 'Ключевые правила и определения', 'Применение знаний на практике'],
    examples: ['Пример: Объединение Руси — исторический анализ', 'Практическое задание по теме «Объединение Руси»'],
  },
  {
    ...
    keyPoints: ['Основные понятия темы «Россия в XVII веке»', 'Ключевые правила и определения', 'Применение знаний на практике'],
    examples: ['Пример: Россия в XVII веке — исторический анализ', 'Практическое задание по теме «Россия в XVII веке»'],
  },
  {
    title: "Объединение русских земель",
