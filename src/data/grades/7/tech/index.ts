...
export const games = [
  {
    ...
    keyPoints: ['Основные понятия темы «Материаловедение»', 'Ключевые правила и определения', 'Применение знаний на практике'],
    examples: ['Пример по теме «Материаловедение»', 'Практическое задание: Материаловедение'],
  },
  {
    ...
    keyPoints: ['Основные понятия темы «Технологии обработки»', 'Ключевые правила и определения', 'Применение знаний на практике'],
    examples: ['Пример по теме «Технологии обработки»', 'Практическое задание: Технологии обработки'],
  },
  {
  ...
  },
  {
    ...
    keyPoints: ['Основные понятия темы «Кулинария и проекты»', 'Ключевые правила и определения', 'Применение знаний на практике'],
    examples: ['Пример по теме «Кулинария и проекты»', 'Практическое задание: Кулинария и проекты'],
  },
  {
    title: "Свойства и пороки древесины",
