...
export const games = [
  {
    ...
    keyPoints: ['Основные понятия темы «Причастие и деепричастие»', 'Ключевые правила и определения', 'Применение знаний на практике'],
    examples: ['Пример: Причастие и деепричастие — анализ языковых явлений', 'Практическое задание по теме «Причастие и деепричастие»'],
  },
  {
    title: "Наречие",
    ...
    keyPoints: ['Основные понятия темы «Наречие»', 'Ключевые правила и определения', 'Применение знаний на практике'],
    examples: ['Пример: Наречие — анализ языковых явлений', 'Практическое задание по теме «Наречие»'],
  },
  {
    ...
    keyPoints: ['Основные понятия темы «Фонетика и состав слова»', 'Ключевые правила и определения', 'Применение знаний на практике'],
    examples: ['Пример: Фонетика и состав слова — анализ языковых явлений', 'Практическое задание по теме «Фонетика и состав слова»'],
  },
  {
    ...
    keyPoints: ['Основные понятия темы «Наречие: правила и usage»', 'Ключевые правила и определения', 'Применение знаний на практике'],
    examples: ['Пример: Наречие: правила и usage — анализ языковых явлений', 'Практическое задание по теме «Наречие: правила и usage»'],
  },
  {
    title: "Фонетика и графика",
