...
export const subjectNames: Record<string, { title: string; icon: string; color: string }> = {
  ...
  coding: { title: "Основы программирования", icon: "Code", color: "text-cyan-400" },
  robotics: { title: "Робототехника", icon: "Cpu", color: "text-violet-400" },
  economy: { title: "Экономика", icon: "TrendingUp", color: "text-amber-400" },
  law: { title: "Основы права", icon: "Scale", color: "text-rose-400" },
