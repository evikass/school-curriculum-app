...
const GAME_BUTTONS: { id: MiniGameType; icon: React.ReactNode; label: string; color: string }[] = [
  ...
  { id: 'abbr', icon: <TextCursorInput className="w-3 h-3 inline mr-1" />, label: 'Аббр', color: 'amber' },
  ...
  { id: 'animals', icon: <PawPrint className="w-3 h-3 inline mr-1" />, label: 'Живот', color: 'green' },
  { id: 'professions', icon: <Briefcase className="w-3 h-3 inline mr-1" />, label: 'Проф', color: 'indigo' },
  { id: 'periodic', icon: <AtomIcon className="w-3 h-3 inline mr-1" />, label: 'Химия', color: 'cyan' },
  { id: 'physics', icon: <FlaskConical className="w-3 h-3 inline mr-1" />, label: 'Физ', color: 'violet' },
      ...
      <div className="max-w-7xl mx-auto relative z-10">
        <header className="text-center mb-6">
          ...
          <div className="flex justify-center gap-2 mt-3 flex-wrap">
            <span className="text-green-400 text-xs bg-green-400/20 px-3 py-1 rounded-full">v2.60</span>
