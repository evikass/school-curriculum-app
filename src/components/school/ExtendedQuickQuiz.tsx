...
const QUIZ_CATEGORIES = {
  ...
  informatics: {
    ...
    questions: [
      // Easy
      { q: "1010₂ в десятичной системе = ?", options: ["8", "10", "12"], answer: "10", difficulty: 'easy' },
      { q: "Сколько бит в байте?", options: ["4", "8", "16"], answer: "8", difficulty: 'easy' },
      { q: "Что такое алгоритм?", options: ["Программа", "Последовательность действий", "Компьютер"], answer: "Последовательность действий", difficulty: 'easy' },
      // Medium
      { q: "1 ∧ 0 = ?", options: ["0", "1", "Не определено"], answer: "0", difficulty: 'medium' },
      { q: "HTTP использует порт:", options: ["21", "80", "443"], answer: "80", difficulty: 'medium' },
      { q: "1 КБ = ?", options: ["1000 байт", "1024 байта", "1000 бит"], answer: "1024 байта", difficulty: 'medium' },
      // Hard
      { q: "Сложность бинарного поиска:", options: ["O(1)", "O(log n)", "O(n)"], answer: "O(log n)", difficulty: 'hard' },
      { q: "2¹⁰ = ?", options: ["512", "1000", "1024"], answer: "1024", difficulty: 'hard' },
    ]
  },
  physics: {
    name: 'Физика',
    ...
    questions: [
      // Easy
      { q: "Единица измерения силы?", options: ["Ньютон", "Джоуль", "Ватт"], answer: "Ньютон", difficulty: 'easy' },
      { q: "Что измеряет вольтметр?", options: ["Силу тока", "Напряжение", "Сопротивление"], answer: "Напряжение", difficulty: 'easy' },
      { q: "Формула скорости?", options: ["v = s/t", "v = t/s", "v = s·t"], answer: "v = s/t", difficulty: 'easy' },
      // Medium
      { q: "F = ma - это закон?", options: ["Ньютона", "Гука", "Ома"], answer: "Ньютона", difficulty: 'medium' },
      { q: "Что такое импульс?", options: ["mv", "ma", "mgh"], answer: "mv", difficulty: 'medium' },
      { q: "Единица мощности?", options: ["Ньютон", "Ватт", "Джоуль"], answer: "Ватт", difficulty: 'medium' },
      // Hard
      { q: "Формула Эйнштейна E = ?", options: ["mc", "mc²", "m²c"], answer: "mc²", difficulty: 'hard' },
      { q: "Что такое энтропия?", options: ["Мера хаоса", "Мера порядка", "Энергия"], answer: "Мера хаоса", difficulty: 'hard' },
    ]
  },
  chemistry: {
    name: 'Химия',
    ...
    questions: [
      // Easy
      { q: "Формула воды?", options: ["H2O", "CO2", "O2"], answer: "H2O", difficulty: 'easy' },
      { q: "Атом - это?", options: ["Молекула", "Частица вещества", "Элемент"], answer: "Частица вещества", difficulty: 'easy' },
      { q: "Сколько элементов в таблице Менделеева?", options: ["108", "118", "128"], answer: "118", difficulty: 'easy' },
      // Medium
      { q: "Окислитель:", options: ["Принимает электроны", "Отдаёт электроны", "Не изменяется"], answer: "Принимает электроны", difficulty: 'medium' },
      { q: "pH нейтральной среды:", options: ["0", "7", "14"], answer: "7", difficulty: 'medium' },
      { q: "Соляная кислота - HCl?", options: ["Да", "Нет", "H2SO4"], answer: "Да", difficulty: 'medium' },
      // Hard
      { q: "Что такое катализатор?", options: ["Ускоряет реакцию", "Замедляет реакцию", "Не влияет"], answer: "Ускоряет реакцию", difficulty: 'hard' },
      { q: "Электроотрицательность - это:", options: ["Способность отдавать", "Способность притягивать", "Масса атома"], answer: "Способность притягивать", difficulty: 'hard' },
    ]
  },
  biology: {
    name: 'Биология',
    ...
    questions: [
      // Easy
      { q: "Какой орган мозга главное?", options: ["Сердце", "Мозг", "Печень"], answer: "Мозг", difficulty: 'easy' },
      { q: "Что такое ДНК?", options: ["Белок", "Носитель наследственности", "Жир"], answer: "Носитель наследственности", difficulty: 'easy' },
      { q: "Сколько хромосом у человека?", options: ["23", "46", "48"], answer: "46", difficulty: 'easy' },
      // Medium
      { q: "Митохондрии - это:", options: ["Энергетические станции", "Ядро клетки", "Мембрана"], answer: "Энергетические станции", difficulty: 'medium' },
      { q: "Фотосинтез происходит в:", options: ["Корнях", "Листьях", "Стебле"], answer: "Листьях", difficulty: 'medium' },
      { q: "Что такое ген?", options: ["Клетка", "Участок ДНК", "Белок"], answer: "Участок ДНК", difficulty: 'medium' },
      // Hard
      { q: "Тип деления клетки:", options: ["Митоз", "Мейоз", "Оба"], answer: "Оба", difficulty: 'hard' },
      { q: "Что такое биосфера?", options: ["Часть Земли с жизнью", "Атмосфера", "Океан"], answer: "Часть Земли с жизнью", difficulty: 'hard' },
    ]
  },
  geography: {
    name: 'География',
    ...
    questions: [
      // Easy
      { q: "Столица России?", options: ["Москва", "Санкт-Петербург", "Новосибирск"], answer: "Москва", difficulty: 'easy' },
      { q: "Сколько материков?", options: ["5", "6", "7"], answer: "6", difficulty: 'easy' },
      { q: "Самый большой океан?", options: ["Атлантический", "Тихий", "Индийский"], answer: "Тихий", difficulty: 'easy' },
      // Medium
      { q: "Самая длинная река?", options: ["Амазонка", "Нил", "Волга"], answer: "Нил", difficulty: 'medium' },
      { q: "Самая высокая гора?", options: ["Эльбрус", "Эверест", "Килиманджаро"], answer: "Эверест", difficulty: 'medium' },
      { q: "Сколько океанов на Земле?", options: ["4", "5", "6"], answer: "5", difficulty: 'medium' },
      // Hard
      { q: "В какой части света Россия?", options: ["Европа", "Азия", "Европа и Азия"], answer: "Европа и Азия", difficulty: 'hard' },
      { q: "Что такое широта?", options: ["Угол от экватора", "Угол от Гринвича", "Расстояние"], answer: "Угол от экватора", difficulty: 'hard' },
    ]
  }
}
