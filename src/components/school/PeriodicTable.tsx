...
// Динамический импорт 3D визуализации (ssr: false — WebGL не работает при SSR)
const AtomVisualization = dynamic(() => import('./AtomVisualization'), { 
  ssr: false,
  loading: () => (
    <div className="w-full h-32 sm:h-40 md:h-48 mx-auto flex items-center justify-center">
      <div className="animate-pulse text-white/40 text-sm">Загрузка 3D...</div>
    </div>
  )
})
