          ...
          <div className="bg-gradient-to-br from-indigo-500/30 via-purple-500/30 to-pink-500/30 
            ...
            {'image' in selectedLesson && selectedLesson.image ? (
              <div className="flex justify-center mb-6">
                <div 
                  className="relative rounded-3xl overflow-hidden border-4 border-purple-400/30 shadow-2xl max-w-2xl w-full cursor-pointer"
            ...
            <div key={topicIndex} 
              ...
              >
                <div className="flex items-center gap-4">
                  <div className="w-14 h-14 min-w-14 min-h-14 rounded-2xl shrink-0
                ...
                <div className="px-6 pb-6 space-y-3 bg-black/20">
                  {topicBlock.lessons.map((lesson, lessonIndex) => {
                    ...
                    return (
                      ...
                      >
                        <div className="flex items-center gap-4">
                          <div className={`w-12 h-12 min-w-12 min-h-12 rounded-xl shrink-0 flex items-center justify-center text-2xl
